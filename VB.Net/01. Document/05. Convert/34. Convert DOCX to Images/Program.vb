...
Namespace Example
	Friend Class Program
		...
		''' <summary>
		''' Convert DOCX to Images (file to file).
		''' </summary>
		''' <remarks>
		''' Details: https://sautinsoft.com/products/document/help/net/developer-guide/convert-docx-to-images-in-csharp-vb.php
		''' </remarks>
		Private Shared Sub ConvertDOCXtoImages()
