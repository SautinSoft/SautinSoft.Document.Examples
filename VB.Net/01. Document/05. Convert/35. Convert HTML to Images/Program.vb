...
Namespace Example
	Friend Class Program
		...
		''' <summary>
		''' Convert HTML to Images (file to file).
		''' </summary>
		''' <remarks>
		''' Details: https://sautinsoft.com/products/document/help/net/developer-guide/convert-html-to-images-in-csharp-vb.php
		''' </remarks>
		Private Shared Sub ConvertHTMLtoImages()
			' Path to a document where to extract pictures.
			' By the way: You may specify DOCX, HTML, RTF files also.
			Dim dc As DocumentCore = DocumentCore.Load("..\..\..\example.html")
